...
/**
 * Ejercicio 10: Crea una clase java cuyo método main añada la variable de entorno MI_NOMBRE
...
public class Ejercicio10 {
	...
	public static void main(String[] args) {
		 ...
		 * actuales de tu programa, de manera que podrás escribir y leer al programa de
		 * manera interactiva como si lo hubieras corrido directamente .
		 */
